...
export default function ContactCTA() {
  ...
  return (
    <section
      ...
      className="bg-ivory-50 section-y"
    >
      <div className="container-x">
        <Reveal className="relative isolate overflow-hidden rounded-[5px] border border-ink-900/10 bg-ink-950 px-6 py-12 text-center sm:px-10 sm:py-14 lg:py-16">
          ...
          <h2
            id="contact-title"
            className="heading-lg mx-auto mt-4 max-w-2xl font-medium text-ivory-100"
          >
            {contact.title}
          </h2>
          <p className="body-text mx-auto mt-4 max-w-xl text-[15px] text-ink-200">
            {contact.subtitle}
          </p>
          ...
          <div className="mt-9 flex flex-col items-center justify-center gap-4 border-t border-ivory-100/10 pt-7 text-[14px] text-ink-300 sm:flex-row sm:gap-8">
            <a
